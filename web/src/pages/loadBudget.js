...
//  */
// class LoadBudget extends BindingClass {
//     constructor() {
//         super();
//         this.bindClassMethods(['clientLoaded', 'mount', 'addBudgetToPage', 'createTable'], this);
...
//         const user = await this.client.createUser(userId, budgetId);
