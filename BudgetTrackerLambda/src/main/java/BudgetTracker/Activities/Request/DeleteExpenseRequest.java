...
public class DeleteExpenseRequest {
    ...
    private DeleteExpenseRequest(String budgetId, String expenseId, String expenseValue, String expenseName) {
    ...
    public boolean equals(Object o) {
        ...
        DeleteExpenseRequest that = (DeleteExpenseRequest) o;
    ...
    public static class Builder {
        ...
        public DeleteExpenseRequest build() {
            return new DeleteExpenseRequest(this.budgetId, this.expenseId, this.expenseValue, this.expenseName);
        }
    }
}
